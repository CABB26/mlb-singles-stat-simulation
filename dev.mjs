...
const assets = {async fetch(request) {
  ...
  if (!['/','/index.html','/style.css','/app.mjs','/model.mjs','/csv.mjs','/imports.mjs','/favicon.svg'].includes(path)) return new Response('Not found',{status:404});
...
}).listen(Number(process.env.PORT)||8787,'127.0.0.1',()=>console.log('HR Machine ready at http://localhost:'+(Number(process.env.PORT)||8787)));
